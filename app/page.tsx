        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-16 pt-10 sm:px-6 lg:px-8 lg:pb-24">
          <div className="grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="max-w-xl">
              <p className="mb-4 inline-flex rounded-full border border-amber-400/40 bg-amber-400/10 px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.24em] text-amber-200">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-6 text-sm text-slate-300">
                <div>
                  <p className="text-xs uppercase tracking-[0.2em] text-slate-400">Opening hours</p>
                  <p className="mt-1 text-base text-white">{business.openingHours}</p>
                </div>
                <div>
            ...
            <div className="rounded-[2rem] border border-white/10 bg-slate-900/60 p-3 shadow-2xl shadow-slate-950/50">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-4 md:grid-cols-4">
          {trustPoints.map((point) => (
            <div
              key={point}
              className="rounded-3xl border border-white/10 bg-slate-900/80 p-5 text-center shadow-lg shadow-slate-950/30"
            >
      ...
      <section className="border-y border-white/10 bg-slate-950/60">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            description="A few recent-style highlights that can be replaced with real guest feedback when it becomes available."
          />
